...
<?php JHTML::stylesheet('modules/mod_leidos_ars_search/css/bounce.animation.css'); ?>
...
<?php JHTML::script('modules/mod_leidos_ars_search/app/controller.js'); ?>
<?php JHTML::script('modules/mod_leidos_ars_search/app/router.js'); ?>

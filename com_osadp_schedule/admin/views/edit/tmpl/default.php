			...
			<legend>Edit Project</legend>
				...
				<div class="row-fluid clearfix">
					<div class="span4">
						...
						<input type="text" required="required" name="name" id="name" value="<?php echo $this->project->name; ?>">
					</div>
					<div class="span4">
					...
					<div class="span4">
						...
						<input type="text" required="required" name="date" id="date" value="<?php echo date_format(date_create($this->project->date), "m-d-Y"); ?>">
					</div>
				</div>
				<!-- NOTES -->
				<div class="row-fluid">

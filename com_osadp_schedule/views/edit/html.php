...
class OsadpViewsEditHtml extends JViewHtml
{
  function render()
  {
    ...
    if( isset($_POST['name']) && isset($_POST['url']) && isset($_POST['date']) && isset($_POST['notes']) ) {
        ...
        $this->updateSuccess = $modelSchedules->updateSchedule($projectId, $name, $image, $url, $date, $fullDate, $notes, $capabilities, $dma, $available, $published, $daysNew, $user->username);
    }
    /**
